...
<el-form-item label="赋税"
label-width="100px">
<el-input v-model="form.scot" autocomplete="off"></el-input>
</el-form-item>
...
<script>
  ...
  submitForm(formName) {
    ...
    if (valid) {
    this.request.post("/stipend" , this.form)
    .then(res => {
  ...
  del(id) {
    this.request.delete("/stipend/" + id).then(res => {
  ...
  delHandle(id) {
    ...
    this.request.post("/stipend/delete/"+ ids).then(res => {
